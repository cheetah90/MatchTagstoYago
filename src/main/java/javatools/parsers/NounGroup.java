...
public class NounGroup {
    ...
    public static String2Boolean isAdjective = new String2Boolean() {
        ...
        public boolean apply(String s) {
            // Allen: add some hardcoding
            if (s.equals("memorial")) {
                return false;
            }
    ...
    public static final FinalSet<String> prepositions = new FinalSet<String>(",", "at", "about", "and", "by", "for", "from", "in", "of", "on", "to",
            "with", "who", "-", "\u2248", "under", "among", "below", "after");
    ...
    public NounGroup(List<String> words) {
        ...
        // If no valid words are left, return an empty NounGroup object
        if (words.size() == 0) {
            head = "";
            postModifier = new NounGroup("");
            preModifier = "";
            return;
        }

        // If the preposition is the first word, this is a invalid noun prahse
        if (prepositions.contains(words.get(0))) {
            head = "";
            postModifier = new NounGroup(words.subList(1, words.size()));
            preModifier = "";
            return;
        }
